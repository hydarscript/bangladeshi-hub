local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/Libary.lua"))()
local AimlockModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/AimLockModule.lua"))()
local ESPModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/ESPModule.lua"))()
local SilentAimModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/SilentAimModule.lua"))()
local StuffsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/StuffModule.lua"))()
local OthersStuffsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/OthersStuffModule.lua"))()
local UiSettingsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/UiSettingsModule.lua"))()
local ZSkillModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/hydarscript/bangladeshi-hub/refs/heads/main/ZSkillModule.lua"))()
...
toggleButton.Image = "rbxassetid://125507862584227"
...
local Window = Library.CreateLib("Bangladeshi hub  |  " .. executor, UiSettingsModule.currentTheme)
...
Section:NewLabel("• Fixed Dropdown Save Settings ✔")
...
local PredictionAimlockAmountDropdown = Section:NewDropdown("・Prediction Amount | Default 0.1s", "Select max Prediction for Aimlock", {"0.2", "0.3", "0.4"}, function(selected)
...
local PredictionAmountDropdown = Section:NewDropdown("・Prediction Future | Default 0.1s", "Select max Prediction for Silent Aim", {"0.2", "0.3", "0.4"}, function(selected)
    local num = tonumber(selected)
    if num then
...
local DistanceAmountDropdown = Section:NewDropdown("・Distance Limit | Default 1000m", "Select max distance for aimbot", {"200", "400", "600"}, function(selected)
    local num = tonumber(selected)
    if num then
...
Section:NewButton("Join Discord", "Get Link Discord server", function()
	local link = "https://discord.gg/z26j59gYN6"
    if setclipboard then
        setclipboard(link)
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Bangladeshi Hub",
...
local BunnyHopToggle = Section:NewToggle("・server hop", "Toggle Bunnyhop", function(state)
    ESPModule:SetBunnyhop(state)
    Settings["BunnyHop"] = state
end)

local AuraSkillToggle = Section:NewToggle("・Auto Haki", "Auto activate Haki", function(state)
    ESPModule:SetBuso(state)
    Settings["AuraSkill"] = state
end)

local FpsOrPingsToggle = Section:NewToggle("・Show Fps-Pings", "Display Ping or Fps", function(state)
...
local GlobalTextDropdown = Section:NewDropdown("・Global Text Font", "Change font for all text", {
    "Arcade",
    "Cartoon",
    "SciFi",
    "Fantasy",
...
local RTXModeDropdown = Section:NewDropdown("・RTX Graphics Mode", "Choose between Autumn or Summer lighting", {"Autumn", "Summer", "Spring", "Winter"}, function(selected)
